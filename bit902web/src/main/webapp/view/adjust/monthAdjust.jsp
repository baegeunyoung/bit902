							...
							<div class="card">
								<div class="card-header" data-background-color="purple">
									...
									<p class="category">
										...
										<span id="cDate">
										<fmt:formatDate value="${now}" pattern="yyyy년 MM월 " var="today" />${today}</span>
										<i class="material-icons text-black" onclick="javascript:nextMonth()" style="cursor: pointer;">
										navigate_next</i>
									</p>
								</div>
