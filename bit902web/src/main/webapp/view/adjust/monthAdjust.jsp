...
<body>
	...
	function productChangeGraph() {
		...
		dataCompletedTasksChart = {
	            labels: arr1,
	            series: [
	                [230, 750, 450, 300, 280, 240, 200, 190, 230, 750, 450, 300, 280, 240, 200, 190, 231],
	                [430, 298, 492, 354, 523, 245, 244, 233, 452, 563, 123, 142, 321, 423, 213, 235, 273],
	                [452, 563, 123, 142, 321, 423, 213, 235, 244, 233, 452, 563, 244, 214, 424, 242, 421]
	            ]
	        };
